...
model AngularVelocityController "Controller of the angular velocity incorporating tip speed ratio and wind speed"
  ...
  Modelica.Blocks.Interfaces.RealInput v "Wind speed" annotation(Placement(transformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}})));
