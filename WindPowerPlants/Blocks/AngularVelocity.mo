...
model AngularVelocity "Calculates the angular velocity from tip speed ratio and wind speed"
  ...
  Modelica.Blocks.Interfaces.RealInput v "Wind speed" annotation(Placement(transformation(origin = {-110, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, 0}, extent = {{-10, -10}, {10, 10}})));
