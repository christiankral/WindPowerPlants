...
model TipSpeedRatio "Determines tip speed ratio"
  ...
  Modelica.Blocks.Interfaces.RealInput v "Wind speed" annotation(Placement(transformation(origin = {-110, 10}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}})));
  Modelica.Blocks.Interfaces.RealOutput lambda "Tip speed ratio" annotation(Placement(transformation(extent = {{100, -10}, {120, 10}})));
  Modelica.Blocks.Interfaces.RealInput w "Angular velocity" annotation(Placement(transformation(origin = {-110, 70}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-120, 60}, extent = {{-20, -20}, {20, 20}})));
equation
  lambda = D / 2 * w / v;
