...
model CpLambdaWindTurbine "Investigate cp versus lambda of wind turbine for different pitch angles"
  ...
  WindPowerPlants.Components.PitchWindTurbine windturbine(D = 101, powerMax = 3.05E6, turbineData = WindPowerPlants.Records.TurbineData.Heier2009()) annotation(Placement(transformation(origin = {-22, 0}, extent = {{-10, -10}, {10, 10}})));
  ...
  WindPowerPlants.Blocks.TriangleAndStep triangleAndStep(T = 1, stepNumber = 10, stepHeight = 90, stepOffset = 0, triangleHeight = 18, triangleOffset = 2) annotation(Placement(transformation(extent = {{-80, 10}, {-60, -10}})));
equation
  ...
  connect(triangleAndStep.triangle, windturbine.v) annotation(Line(points = {{-59, 6}, {-46, 6}, {-46, 8.88178e-16}, {-33, 8.88178e-16}}, color = {0, 0, 127}));
  connect(triangleAndStep.step, windturbine.beta) annotation(Line(points = {{-59, -6}, {-33, -6}}, color = {0, 0, 127}));
