package WindPowerPlants "Library of wind power plants"
  ...
  annotation(version = "0.9.5", versionBuild = 1, versionDate = "2015-09-30", uses(Modelica(version = "3.2.1"), Complex(version = "3.2.1")), preferredView = "info", Documentation(info = "<html>
