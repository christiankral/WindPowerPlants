...
package WindPowerPlants "Library of wind power plants"
  ...
  annotation(version = "1.X.X", versionBuild = 1, versionDate = "2018-XX-XX", uses(Modelica(version = "3.2.2"), Complex(version = "3.2.2")), preferredView = "info", Documentation(info = "<html>
